 ...
 <!-- MAIN -->
	 <main class="main-content">
	  ...
	  <form class="form form-client" method="post" action="ServletClientList">
	    <fieldset class="form__fieldset">
	      <legend class="form__legend">Nuevo Cliente</legend>
		      ...
		      <div class="form__group_left">
		        ...
		        <select id="sexo" class="form__select" required name="gender">
	      ...
	      <div class="form__group_right">
	        ...
	        <input type="text" id="address" required name="address" placeholder="Calle número" class="form__input" 
	        	value="Falsa 123"/>
	      </div>
			</div>
	    ...
	    <input type="submit" name="btnNewClient" value="Guardar Cliente" class="form__submit"/>
